...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x):
        ...
        x = self.decoderbranch(x, features)
        logits = self.mask(x)
        return logits
...
def get_b16_config():
    ...
    config.pretrained_path = 'models/pretrained_models/ViT-B_16.npz'
...
def get_r50_b16_config():
    ...
    config.classifier = 'seg'
    config.pretrained_path = 'models/pretrained_models/R50+ViT-B_16.npz'
    config.decoder_channels = (256, 128, 64, 16)
